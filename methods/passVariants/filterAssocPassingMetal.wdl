...
task getScript {
	command {
		wget "https://raw.githubusercontent.com/manning-lab/topmed-t2d-glycemia-public/master/methods/passVariants/filterAssocPassingMetal.R"
	}
	...
	output {
		File script = "filterAssocPassingMetal.R"
	}
}
