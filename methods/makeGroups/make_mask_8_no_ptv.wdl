task getScript {
	command {
		wget "https://raw.githubusercontent.com/manning-lab/topmed-t2d-glycemia-public/make_groups/methods/makeGroups/make_mask_8_no_ptv.R"
	...
	output {
		File script = "make_mask_8_no_ptv.R"
...
task makeGroups {
    ...
    output {
    	File csv = "freeze5b_dp10.${chr}.mask8.no.ptv.csv"
    }	
...
workflow wf {
	...
	#Array[String] chrs = ["chr1","chr10","chr11","chr12","chr13","chr14","chr15","chr16","chr17","chr18","chr19","chr2","chr20","chr21","chr22","chr3","chr4","chr5","chr6","chr7","chr8","chr9","chrX"]
	Array[String] chrs = ["chr10"]
